...
exports.signInFit = exports.signIn = exports.verifyFitOTP = exports.verifyOTP = exports.signupFit = exports.signup = void 0;
const User_1 = __importDefault(require("../models/User"));
const Otp_1 = __importDefault(require("../models/Otp"));
const FitUsers_1 = __importDefault(require("../models/FitUsers"));
...
const signupFit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log("sign up data: ", req.body);
    const { firstName, lastName, email, password, dateOfBirth, gender } = req.body;
    try {
        let user = yield FitUsers_1.default.findOne({ email });
        if (user && user.verified) {
            res.status(409).json({ message: "User already exists" });
        }
        const otp = Math.floor(100000 + Math.random() * 900000);
...
const verifyFitOTP = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email, otp } = req.body;
    try {
        const otpData = yield Otp_1.default.findOne({ email });
        const user = yield FitUsers_1.default.findOne({ email });
        if (otpData)
            console.log(typeof otpData.otp);
        console.log(typeof Number(otp));
        if (!user) {
...
exports.verifyFitOTP = verifyFitOTP;
...
const signInFit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const JWT_SECRET = process.env.JWT_SECRET; // Type assertion
    const { email, password } = req.body;
    console.log("sign In data: ", req.body);
    try {
